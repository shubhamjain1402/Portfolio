export interface Project { name: string; role: string; description: string; impact: string; features: string[]; stack: string[]; live?: string; github?: string; accent: string; }
...
export const portfolio = {
 ...
 bio: 'AI, machine learning, and full-stack development. I build practical applications that turn data into useful decisions.',
 ...
 achievementsSection: {index:'02',label:'Achievements',title:'Learning in practice',description:'Certifications and challenge participation across machine learning, cloud computing, and software development.'},
 ...
 educationSection: {index:'03',label:'Education',title:'Education and skills',description:'A computer science foundation at VIT Bhopal, with a focus on artificial intelligence and machine learning.'},
 ...
 contactSection: {index:'04',label:'Links',title:'Let’s build useful things.',description:'Interested in practical projects where AI, data, and thoughtful software engineering come together.'},
